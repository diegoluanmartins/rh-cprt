...
public class SalaryUpgradeService {
    ...
    public void upgradeEmployeeSalary(final Employee employee, final double percentage){
        ...
        BigDecimal newSalary = employee.getPersonalData().getMonthlySalary().multiply(BigDecimal.valueOf(1 + percentage)).setScale(2, STD_ROUNDING_MODE);
    ...
    public void upgradeEmployeeSalary(final Employee employee, final double fixedValue, RoundingMode roundingMode){
        ...
        final double percentage = BigDecimal.valueOf(fixedValue).divide(employee.getPersonalData().getMonthlySalary(), 3, roundingMode).doubleValue();
